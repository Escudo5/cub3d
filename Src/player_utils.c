...
void handle_rotation_left(t_scene *scene)
{
    ...
    camera->dir_x = camera->dir_x * cos(-rot_speed)
        - camera->dir_y * sin(-rot_speed);
    camera->dir_y = old_dir_x * sin(-rot_speed)
        + camera->dir_y * cos(-rot_speed);
    camera->plane_x = camera->plane_x * cos(-rot_speed)
...
/*   Updated: 2025/09/15 14:08:17 by smarquez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
